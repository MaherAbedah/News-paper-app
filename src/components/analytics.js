...
export default function Analytics() {
  ...
  const percentageData = [
  	{
  		angle0: 0, angle: Math.PI * 2 * 0.5 ,  radius: 3, radius0: 2, color:'#2AD46FFF'
  	},
  	{
  		angle0: 0 , angle: -Math.PI * 2 * 0.25,  radius: 2, radius0: 1, color:'#EDDB11FF'

  	},
  	{
  		angle0: -Math.PI , angle: -Math.PI * 2 * 0.25,  radius: 1, radius0: 0, color:'#FF41FCFF'
          	...
          	<div>
				<List className={classes.list}>
			      <ListItem button>
			        ...
			        <ListItemText primary="article1" secondary="270 reads" />
			      </ListItem>
			      <ListItem button>
			        <ListItemAvatar>
			          <Avatar>
